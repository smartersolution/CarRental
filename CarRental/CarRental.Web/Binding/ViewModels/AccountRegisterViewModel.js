    ...
    var AccountRegisterViewModel = function () {
        ...
        self.viewMode.subscribe(function () {
            switch (self.viewMode()) {
                case 'register1':
                    self.viewModelHelper.pushUrlState('register1', null, null, 'account/register');
                    break;
                case 'register2':
                    self.viewModelHelper.pushUrlState('register2', null, null, 'account/register');
                    break;
                case 'register3':
                    self.viewModelHelper.pushUrlState('register3', null, null, 'account/register');
                    break;
                case 'confirm':
                    self.viewModelHelper.pushUrlState('confirm', null, null, 'account/register');
                    break;
            }
